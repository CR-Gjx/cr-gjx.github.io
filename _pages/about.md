...
- I am now a Research Scientist at Google Research Australia, dedicated to enhancing the inference efficiency of large foundation models and proposing efficient model architectures. At Google, I am the main contributor of [Gemma3n](https://deepmind.google/models/gemma/gemma-3n/), the open-sourced LLM for on-device use cases, where I launched the main feature for the architecture change for it. I also contributed Gemini-2.5 series and next generation of Gemini model design. 
